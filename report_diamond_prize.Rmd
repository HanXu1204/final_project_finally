...
The table below shows a linear regression model for the relationship between prices and size, quality, size of the table facet among diamonds.
...
In this analysis, a binary outcome where level 1 of the outcome
means the price of a diamond was greater than `r median(data$price)` is generated. 
